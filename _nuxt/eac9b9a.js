    ...
    463: function (t, r, e) {
      ...
      !(function (o) {
        var f = /^\s+/,
          ...
          m = o.random;
        function v(t, r) {
          if (((r = r || {}), (t = t || "") instanceof v)) return t;
          ...
          var e = (function (t) {
            ...
            "string" == typeof t &&
              (t = (function (t) {
                ...
                if ((r = W.rgb.exec(t))) return { r: r[1], g: r[2], b: r[3] };
                if ((r = W.rgba.exec(t)))
                  return { r: r[1], g: r[2], b: r[3], a: r[4] };
                if ((r = W.hsl.exec(t))) return { h: r[1], s: r[2], l: r[3] };
                if ((r = W.hsla.exec(t)))
                  return { h: r[1], s: r[2], l: r[3], a: r[4] };
                if ((r = W.hsv.exec(t))) return { h: r[1], s: r[2], v: r[3] };
                if ((r = W.hsva.exec(t)))
                ...
                : Y(t.h) &&
                  ...
                  (r = (function (t, s, r) {
                    ...
                    if (
                      ...
                      var q = r < 0.5 ? r * (1 + s) : r + s - r * s,
                        p = 2 * r - q;
                      (e = n(p, q, t + 1 / 3)),
                        (g = n(p, q, t)),
                        (b = n(p, q, t - 1 / 3));
                    }
                    return { r: 255 * e, g: 255 * g, b: 255 * b };
                  })(t.h, s, n)),
                  (l = !0),
                  (c = "hsl")),
        ...
        function y(t, g, b) {
          ...
          if (e == n) r = s = 0;
            ...
            var f = e - n;
            switch (((s = o > 0.5 ? f / (2 - e - n) : f / (e + n)), e)) {
              case t:
                r = (g - b) / f + (g < b ? 6 : 0);
                break;
              case g:
        ...
        function w(t, r) {
          r = 0 === r ? 0 : r || 10;
          var e = v(t).toHsl();
          return (e.s -= r / 100), (e.s = D(e.s)), v(e);
        }
        function S(t, r) {
          r = 0 === r ? 0 : r || 10;
          var e = v(t).toHsl();
        ...
        function R(t, r) {
          r = 0 === r ? 0 : r || 10;
          var e = v(t).toHsl();
          return (e.l += r / 100), (e.l = D(e.l)), v(e);
        }
        function F(t, r) {
          r = 0 === r ? 0 : r || 10;
          var e = v(t).toRgb();
          return (
            (e.r = _(0, d(255, e.r - c((-r / 100) * 255)))),
            (e.g = _(0, d(255, e.g - c((-r / 100) * 255)))),
            (e.b = _(0, d(255, e.b - c((-r / 100) * 255)))),
            v(e)
          );
        }
        function C(t, r) {
        ...
        function M(t, r) {
          var e = v(t).toHsl(),
            n = (e.h + r) % 360;
          return (e.h = n < 0 ? 360 + n : n), v(e);
        }
        function I(t) {
          var r = v(t).toHsl();
          return (r.h = (r.h + 180) % 360), v(r);
        }
        function L(t) {
          var r = v(t).toHsl(),
            e = r.h;
          return [
            v(t),
            v({ h: (e + 120) % 360, s: r.s, l: r.l }),
            v({ h: (e + 240) % 360, s: r.s, l: r.l }),
          ];
        }
        function N(t) {
          var r = v(t).toHsl(),
          ...
          return [
            v(t),
            v({ h: (e + 90) % 360, s: r.s, l: r.l }),
            v({ h: (e + 180) % 360, s: r.s, l: r.l }),
            v({ h: (e + 270) % 360, s: r.s, l: r.l }),
          ];
        }
        function z(t) {
          var r = v(t).toHsl(),
          ...
          return [
            v(t),
            v({ h: (e + 72) % 360, s: r.s, l: r.l }),
            v({ h: (e + 216) % 360, s: r.s, l: r.l }),
          ];
        }
        function E(t, r, e) {
          (r = r || 6), (e = e || 30);
          ...
          for (n.h = (n.h - ((o * r) >> 1) + 720) % 360; --r; )
            (n.h = (n.h + o) % 360), f.push(v(n));
          return f;
        }
        function T(t, r) {
          r = r || 6;
          for (
            var e = v(t).toHsv(), n = e.h, s = e.s, o = e.v, f = [], h = 1 / r;
            r--;

          )
            f.push(v({ h: n, s: s, v: o })), (o = (o + h) % 1);
          return f;
        }
        (v.prototype = {
          isDark: function () {
          ...
          setAlpha: function (t) {
            return (
              (this._a = P(t)), (this._roundA = c(100 * this._a) / 100), this
            );
          },
          toHsv: function () {
          ...
          toHslString: function () {
            ...
            return 1 == this._a
              ? "hsl(" + r + ", " + s + "%, " + e + "%)"
              : "hsla(" + r + ", " + s + "%, " + e + "%, " + this._roundA + ")";
          },
          toHex: function (t) {
            return x(this._r, this._g, this._b, t);
          },
          toHexString: function (t) {
            return "#" + this.toHex(t);
          },
          toHex8: function (t) {
            return (function (t, g, b, a, r) {
              var e = [
                B(c(t).toString(16)),
                B(c(g).toString(16)),
                B(c(b).toString(16)),
          ...
          toName: function () {
            return 0 === this._a
              ? "transparent"
              : !(this._a < 1) && (O[x(this._r, this._g, this._b, !0)] || !1);
          },
          toFilter: function (t) {
            var r = "#" + k(this._r, this._g, this._b, this._a),
              e = r,
              n = this._gradientType ? "GradientType = 1, " : "";
            if (t) {
              var s = v(t);
              e = "#" + k(s._r, s._g, s._b, s._a);
            }
            return (
          ...
          (v.fromRatio = function (t, r) {
            if ("object" == typeof t) {
              var e = {};
              for (var i in t)
                t.hasOwnProperty(i) && (e[i] = "a" === i ? t[i] : J(t[i]));
              t = e;
            }
            return v(t, r);
          }),
          (v.equals = function (t, r) {
            return !(!t || !r) && v(t).toRgbString() == v(r).toRgbString();
          }),
          (v.random = function () {
            return v.fromRatio({ r: m(), g: m(), b: m() });
          }),
          (v.mix = function (t, r, e) {
            e = 0 === e ? 0 : e || 50;
            var n = v(t).toRgb(),
              o = v(r).toRgb(),
              p = e / 100;
          ...
          (v.readability = function (t, r) {
            var e = v(t),
              n = v(r);
            return (
              (o.max(e.getLuminance(), n.getLuminance()) + 0.05) /
              (o.min(e.getLuminance(), n.getLuminance()) + 0.05)
            );
          }),
          (v.isReadable = function (t, r, e) {
            var n,
              o,
              f = v.readability(t, r);
            switch (
          ...
          (v.mostReadable = function (t, r, e) {
            ...
            for (var i = 0; i < r.length; i++)
              (n = v.readability(t, r[i])) > c && ((c = n), (l = v(r[i])));
            return v.isReadable(t, l, { level: f, size: h }) || !o
              ? l
              : ((e.includeFallbackColors = !1),
                v.mostReadable(t, ["#fff", "#000"], e));
          });
        var j = (v.names = {
            aliceblue: "f0f8ff",
            antiquewhite: "faebd7",
          ...
          O = (v.hexNames = (function (t) {
            var r = {};
            for (var i in t) t.hasOwnProperty(i) && (r[t[i]] = i);
            return r;
          })(j));
        function P(a) {
          return (
